...
const ExhibitionContent = ({ exhibition }: { exhibition: Exhibition }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto w-full relative">
      <StickyCloseButton className="fixed z-50" onClick={() => router.back()} />
      ...
      <div className="border border-black rounded-xl p-6 relative">
        ...
        <div className="flex flex-col gap-12">
          ...
          {/* Intro + Main text (grouped); custom margins on the bordered + text blocks */}
          ...
          {(exhibition.bio?.length ||
            ...
            <div className="flex flex-col md:flex-row gap-6 md:items-stretch">
              {/* Bio (left) — bordered with its own margin control */}
              ...
              {/* Portrait gallery (right) + portrait videos */}
